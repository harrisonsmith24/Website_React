                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input name="customeremail" id="customeremail" value={this.state.employeeemail} onChange={this.handleChange} />
                                    </td>
                                </tr>
                                <tr>
                                    <th>Customer Password</th>
                                    <td>
                                        <input type = "password" name="customerpw" id="customerpw" value={this.state.employeepw} onChange={this.handleChange} />
                                    </td>
                                </tr>
